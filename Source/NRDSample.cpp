...
#    endif
        ...
        nri::Result result = NRI.AcquireNextTexture(*m_SwapChain, *queuedFrame.textureAcquiredSemaphore, backBufferIndex);
        ...
        { // UI
            ...
            {
                RenderImgui(commandBuffer, *m_Streamer, backBuffer.attachmentFormat, m_SdrScale, m_IsSrgb);
            }
